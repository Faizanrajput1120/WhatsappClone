...
const VALID_TRANSITIONS = {
  ...
  [CALL_STATES.CALLING]:      [CALL_STATES.CONNECTING, CALL_STATES.ENDED, CALL_STATES.REJECTED, CALL_STATES.FAILED, CALL_STATES.IDLE, CALL_STATES.BUSY],
  ...
  [CALL_STATES.BUSY]:         [CALL_STATES.IDLE],
};
